...
func main() {
	...
	apis.NewAPI("/business_client",
		postgres,
		routes.NewBusinessClientRoutes(),
		handlers.NewBusinessClientHandler(),
		business.NewBusinessClientBusiness(), e, authAPI)
	apis.NewAPI("/business_staff",
		postgres,
