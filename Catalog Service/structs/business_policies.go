...
type BusinessPolicies struct {
	...
	CancellationHours          int    `json:"cancellation_hours,omitempty" gorm:"column:cancellation_hours"`
	CancellationAmount         int    `json:"cancellation_amount,omitempty" gorm:"column:cancellation_amount"`
	NoShowFee                  int    `json:"no_show_fee,omitempty" gorm:"column:no_show_fee"`
	BookingDepositePercentage int    `json:"booking_deposite_percentage,omitempty" gorm:"column:booking_deposite_percentage"`
