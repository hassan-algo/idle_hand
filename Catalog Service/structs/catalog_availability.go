...
type CatalogAvailability struct {
	...
	HoursPerDay             int    `json:"hours_per_day,omitempty" gorm:"column:hours_per_day"`
	SlotsPerDay             string `json:"slots_per_day,omitempty" gorm:"column:slots_per_day"`
	NumberOfBreaks          int    `json:"number_of_breaks,omitempty" gorm:"column:number_of_breaks"`
	TimePerBreak            string `json:"time_per_break,omitempty" gorm:"column:time_per_break"`
	BufferPerAppointment    int    `json:"buffer_per_appointment,omitempty" gorm:"column:buffer_per_appointment"`
	AcceptSameDayBooking    int    `json:"accept_same_day_booking,omitempty" gorm:"column:accept_same_day_booking"`
}
