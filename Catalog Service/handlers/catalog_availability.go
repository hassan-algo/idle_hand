...
func (p *CatalogAvailabilityHandlers) POST(ctx echo.Context) error {
	...
	return ctx.JSON(http.StatusOK, structs.Response{
		Valid:       true,
		Message:     "Catalog availability created successfully",
		Data:        mydata,
...
func (p *CatalogAvailabilityHandlers) PUT(ctx echo.Context) error {
	...
	return ctx.JSON(http.StatusOK, structs.Response{
		Valid:       true,
		Message:     "Catalog availability updated successfully",
		Data:        mydata,
		Status_code: http.StatusOK,
	})
}
...
func (p *CatalogAvailabilityHandlers) DELETE(ctx echo.Context) error {
	...
	return ctx.JSON(http.StatusOK, structs.Response{
		Valid:       true,
		Message:     "Catalog availability deleted successfully",
		Data:        mydata,
		Status_code: http.StatusOK,
	})
}
...
func (p *CatalogAvailabilityHandlers) GETBYID(ctx echo.Context) error {
	...
	return ctx.JSON(http.StatusOK, structs.Response{
		Valid:       true,
		Message:     "Catalog availability fetched successfully",
		Data:        mydata,
		Status_code: http.StatusOK,
	})
}
